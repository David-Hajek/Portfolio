import { i as getContext, s as setContext, j as bind_props, c as pop, p as push, e as attr_style, g as stringify } from "../../chunks/index2.js";
import "clsx";
...
import "mitt";
import { o as onDestroy, B as BlackHoleShader } from "../../chunks/BlackHoleShader.js";
...
function ImageShader($$payload, $$props) {
  push();
  let imageSrc = $$props["imageSrc"];
  let exactWidth = fallback($$props["exactWidth"], void 0);
  let exactHeight = fallback($$props["exactHeight"], void 0);
  let minHeight = fallback($$props["minHeight"], "400px");
  onDestroy(() => {
  });
  $$payload.out += `<div class="image-container svelte-jj7csg"${attr_style(`${exactWidth || exactHeight ? "" : `min-height: ${minHeight};`}`)}><img${attr("src", `${base}${imageSrc}`)} alt="Shader Effect" class="svelte-jj7csg"></div>`;
  bind_props($$props, {
    imageSrc,
    exactWidth,
    exactHeight,
...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<!--]--> <div class="landing-page dark-section svelte-8ksy5q"><div id="glass-landing" class="svelte-8ksy5q"></div> <div class="hero-container svelte-8ksy5q"><div class="hero-content svelte-8ksy5q"><div class="hero-text svelte-8ksy5q"><div class="identity svelte-8ksy5q"><span class="greeting svelte-8ksy5q">Hi, I'm</span> <h1 class="name svelte-8ksy5q">David</h1></div> <h2 class="profession svelte-8ksy5q">3D Artist &amp; Visual Designer</h2> <div class="tagline svelte-8ksy5q">Transforming creative concepts into stunning digital experiences</div> <div class="description svelte-8ksy5q"><p class="svelte-8ksy5q">I specialize in creating immersive 3D visuals and compelling digital art that helps
						...
						artistic vision.</p></div> <div class="hero-cta svelte-8ksy5q"><a${attr("href", `${stringify(base)}/personal`)} class="primary-btn svelte-8ksy5q">View My Work</a> <a${attr("href", `${stringify(base)}/contact`)} class="secondary-btn svelte-8ksy5q">Let's Talk</a></div></div> <div class="hero-visual svelte-8ksy5q"><div class="image-container svelte-8ksy5q">`;
  ImageShader($$payload, { imageSrc: "/images/landing.jpg" });
  $$payload.out += `<!----></div></div></div></div></div> <div class="landing-page svelte-8ksy5q"><div id="glass-landingWhite" class="svelte-8ksy5q"></div> <div class="featured-container svelte-8ksy5q"><div class="featured-content svelte-8ksy5q"><h1 class="section-title svelte-8ksy5q">Featured Work</h1> <div class="accent-bar svelte-8ksy5q"></div> <div class="featured-grid svelte-8ksy5q"><a${attr("href", `${stringify(base)}/project/visualization`)} class="featured-item svelte-8ksy5q"><div class="featured-image-container svelte-8ksy5q"><img${attr("src", `${stringify(base)}/images/projects/wrap/thumbnail.webp`)} alt="3D Visualization Project" class="svelte-8ksy5q"> <div class="featured-overlay svelte-8ksy5q"><h3 class="svelte-8ksy5q">THE MAG WRAP 2025</h3> <p class="svelte-8ksy5q">Garment &amp; Crowd Simulations</p> <span class="view-details svelte-8ksy5q">View Project →</span></div></div></a></div></div></div></div> <div class="logos svelte-8ksy5q"><div class="logos-slide svelte-8ksy5q"><img${attr("src", `${stringify(base)}/images/apparently-logo.png`)} alt="Apparently Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/krystof-logo.png`)} alt="Krystof Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/mira-logo.png`)} alt="Mira Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/devomi-logo.png`)} alt="Devomi Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/dyky-logo.png`)} alt="dykast Logo" class="logo svelte-8ksy5q"></div> <div class="logos-slide svelte-8ksy5q"><img${attr("src", `${stringify(base)}/images/apparently-logo.png`)} alt="Apparently Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/krystof-logo.png`)} alt="Krystof Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/mira-logo.png`)} alt="Mira Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/devomi-logo.png`)} alt="Devomi Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/dyky-logo.png`)} alt="dykast Logo" class="logo svelte-8ksy5q"></div> <div class="logos-slide svelte-8ksy5q"><img${attr("src", `${stringify(base)}/images/apparently-logo.png`)} alt="Apparently Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/krystof-logo.png`)} alt="Krystof Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/mira-logo.png`)} alt="Mira Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/devomi-logo.png`)} alt="Devomi Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/dyky-logo.png`)} alt="dykast Logo" class="logo svelte-8ksy5q"></div> <div class="logos-slide svelte-8ksy5q"><img${attr("src", `${stringify(base)}/images/apparently-logo.png`)} alt="Apparently Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/krystof-logo.png`)} alt="Krystof Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/mira-logo.png`)} alt="Mira Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/devomi-logo.png`)} alt="Devomi Logo" class="logo svelte-8ksy5q"> <img${attr("src", `${stringify(base)}/images/dyky-logo.png`)} alt="dykast Logo" class="logo svelte-8ksy5q"></div></div> <div class="landing-page dark-section svelte-8ksy5q"><div id="glass-landing" class="svelte-8ksy5q"></div> <div class="testimonials-container svelte-8ksy5q"><div class="testimonials-content svelte-8ksy5q"><h1 class="section-title svelte-8ksy5q">Client Testimonials</h1> <div class="accent-bar svelte-8ksy5q"></div> <div class="testimonials-grid svelte-8ksy5q"><div class="testimonial-card svelte-8ksy5q"><div class="testimonial-content svelte-8ksy5q"><svg class="quote-icon svelte-8ksy5q" viewBox="0 0 24 24" fill="currentColor"><path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" class="svelte-8ksy5q"></path></svg> <p class="testimonial-text svelte-8ksy5q">"Working with David was a real pleasure. He is quick to respond to any requests and
							very accommodating, making co-operating smooth and effective. Can always be trusted to
							deliver!"</p> <div class="testimonial-author svelte-8ksy5q"><strong class="svelte-8ksy5q">Mira Lumière</strong> <span class="svelte-8ksy5q">Director @ Yoimira Entertainment</span> <img${attr("src", `${stringify(base)}/images/mira-logo.png`)} alt="Mira Logo" class="logo-testamonial svelte-8ksy5q" style="opacity:0.5"></div></div></div> <div class="testimonial-card svelte-8ksy5q"><div class="testimonial-content svelte-8ksy5q"><svg class="quote-icon svelte-8ksy5q" viewBox="0 0 24 24" fill="currentColor"><path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" class="svelte-8ksy5q"></path></svg> <p class="testimonial-text svelte-8ksy5q">"David is a great addition to my team. He knows his way around 3D graphics and isn’t
