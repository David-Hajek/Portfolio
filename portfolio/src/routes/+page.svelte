<script lang="ts">
	...
	function handleIntersection(entries: IntersectionObserverEntry[]) {
		// this gets the intersectionObserverEntry from the svelte-intersection-observer
	...
	<div class="hero-container">
		<div class="hero-content">
			<div class="hero-text">
				...
				<h2 class="profession">3D Artist & Visual Designer</h2>

				<div class="tagline">Transforming creative concepts into stunning digital experiences</div>

				<div class="description">
					<p>
						I specialize in creating immersive 3D visuals and compelling digital art that helps
						brands and businesses stand out in the digital space.
					</p>
					<p>
						With expertise in the 3D sphere, I bring ideas to life through technical excellence and
						artistic vision.
					</p>
				</div>
			...
			<div class="testimonials-grid">
				<div class="testimonial-card">
					<div class="testimonial-content">
						...
						<p class="testimonial-text">
							"Working with David was a real pleasure. He is quick to respond to any requests and
						...
						<div class="testimonial-author">
							...
							<img
								src="{base}/images/mira-logo.png"
								alt="Mira Logo"
								class="logo-testamonial"
								style="opacity:0.5"
							/>
						</div>
					</div>
				...
				<div class="testimonial-card">
					<div class="testimonial-content">
						...
						<p class="testimonial-text">
							"David is a great addition to my team. He knows his way around 3D graphics and isn’t
							...
							keep playing a big part in our projects' success."
						</p>
						<div class="testimonial-author">
							<strong>Krystof Jezek</strong>
							<span>Motion Director @ Krystof Jezek</span>
							<img
								src="{base}/images/krystof-logo.png"
								alt="Krystof Logo"
								class="logo-testamonial"
								style="opacity:0.5"
							/>
	...
	<div class="sections-container">
		<div class="sections-content">
			<div class="sections-left">
				...
				<div class="accent-bar"></div>
				<p class="mega-description">Choose your journey through my portfolio collections</p>
			</div>
...
{#if showGif}
	<div class="cursor-preview" style="left: {mouseX + 180}px; top: {mouseY - 50}px;">
