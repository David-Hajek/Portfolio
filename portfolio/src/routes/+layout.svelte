			...
			<nav class="nav-blur desktop-nav">
				<ul>
					<li>
						<a
							href="{base}/"
							class={$page.url.pathname === `${base}/` || $page.url.pathname === '/'
								? 'nav-link active'
								: 'nav-link'}
							data-sveltekit-preload-data
							aria-current={$page.url.pathname === `${base}/` || $page.url.pathname === '/'
								? 'page'
								: undefined}>HOME</a
						>
					</li>
					<li>
						<a
							...
							class={$page.url.pathname === `${base}/commercial` ||
							$page.url.pathname === '/commercial'
								? 'nav-link active'
								: 'nav-link'}
							data-sveltekit-preload-data
							aria-current={$page.url.pathname === `${base}/commercial` ||
							$page.url.pathname === '/commercial'
								? 'page'
								: undefined}>COMMERCIAL</a
						>
					</li>
					<li>
						<a
							href="{base}/personal"
							class={$page.url.pathname === `${base}/personal` || $page.url.pathname === '/personal'
								? 'nav-link active'
								: 'nav-link'}
							data-sveltekit-preload-data
							aria-current={$page.url.pathname === `${base}/personal` ||
							$page.url.pathname === '/personal'
								? 'page'
								: undefined}>PERSONAL</a
						>
					</li>
					<li>
						<a
							href="{base}/retro"
							class={$page.url.pathname === `${base}/retro` || $page.url.pathname === '/retro'
								? 'nav-link active'
								: 'nav-link'}
							data-sveltekit-preload-data
							aria-current={$page.url.pathname === `${base}/retro` ||
							$page.url.pathname === '/retro'
								? 'page'
								: undefined}>RETRO</a
						>
					</li>
					<li>
						<a
							href="{base}/about_me"
							class={$page.url.pathname === `${base}/about_me` || $page.url.pathname === '/about_me'
								? 'nav-link active'
								: 'nav-link'}
							data-sveltekit-preload-data
							aria-current={$page.url.pathname === `${base}/about_me` ||
							$page.url.pathname === '/about_me'
								? 'page'
								: undefined}>ABOUT ME</a
						>
					</li>
					<li>
						<a
							href="{base}/contact"
							class={$page.url.pathname === `${base}/contact` || $page.url.pathname === '/contact'
								? 'nav-link active'
								: 'nav-link'}
							data-sveltekit-preload-data
							aria-current={$page.url.pathname === `${base}/contact` ||
	...
	<nav class={`mobile-nav ${isMobileMenuOpen ? 'active' : ''}`}>
		<ul>
			...
			<li>
				<a
					href="{base}/commercial"
					class:active={$page.url.pathname === `${base}/commercial` ||
						$page.url.pathname === '/commercial'}
					on:click={() => toggleMobileMenu()}
				>
					COMMERCIAL
			...
			<li>
				<a
					href="{base}/personal"
					class:active={$page.url.pathname === `${base}/personal` ||
						$page.url.pathname === '/personal'}
					on:click={() => toggleMobileMenu()}
				>
					PERSONAL
			...
			<li>
				<a
					href="{base}/about_me"
					class:active={$page.url.pathname === `${base}/about_me` ||
						$page.url.pathname === '/about_me'}
					on:click={() => toggleMobileMenu()}
				>
					ABOUT ME
		...
		<div class="footer-grid">
			<div class="footer-column left">
				...
				<div class="social-links">
					<a
						href="https://www.linkedin.com/in/david-h%C3%A1jek-98901b292/"
						target="_blank"
						class="social-link"
					>
					...
					<a
						href="https://www.instagram.com/dejvid.hajek/?hl=en"
						target="_blank"
						class="social-link"
					>
