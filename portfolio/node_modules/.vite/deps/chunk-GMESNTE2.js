...
var runObserve = (dependencies, callback, pre) => {
  ...
  const deps = user_derived(() => dependencies().map((d, i) => {
...
function T($$anchor, $$props) {
  ...
  let internalRef = user_derived(() => determineRef(is(), $$props.args));
...
//# sourceMappingURL=chunk-GMESNTE2.js.map
