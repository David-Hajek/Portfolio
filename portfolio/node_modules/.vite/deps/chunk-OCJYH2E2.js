...
import {
  ...
  Vector4,
  WebGLRenderTarget
} from "./chunk-ZJ73KPTD.js";

// node_modules/threlte-postprocessing/dist/selection/context.js
var START_CONTEXT_KEY = "1BYE_EFFECT_SELECTION_CONTEXT_";
function createSelectionContext(props) {
...
// node_modules/threlte-postprocessing/dist/effect-composer/context.js
var START_CONTEXT_KEY2 = "1BYE_EFFECT_COMPOSER_CONTEXT_";
function createEffectComposerContext(data, id) {
  return setContext(`${START_CONTEXT_KEY2}${id ?? ""}`, writable(data));
}
function getEffectComposerContext(id) {
  return getContext(`${START_CONTEXT_KEY2}${id ?? ""}`);
}
...
export {
  ...
  getSelectionContext,
  createEffectComposerContext,
  getEffectComposerContext,
  EffectComposer,
  EffectAttribute,
  BlendFunction,
  Effect,
...
postprocessing/build/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OCJYH2E2.js.map
