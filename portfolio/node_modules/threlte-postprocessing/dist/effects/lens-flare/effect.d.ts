import { type Color, type Texture, type Vector2, type Vector3 } from "three";
import { type BlendFunction, Effect } from "postprocessing";
...
export declare class LensFlareEffect extends Effect {
    ...
    updateUniforms(): void;
    updateState(state: Partial<LensFlareEffectOptions>): void;
}
