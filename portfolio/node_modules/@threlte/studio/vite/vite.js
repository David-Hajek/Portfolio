...
var toMagicString = /* @__PURE__ */ __name((markup) => {
  return new MagicString2(markup);
}, "toMagicString");
...
var transformScript = /* @__PURE__ */ __name((code, id, module) => {
  const members = [];
...
var transformStaticState = /* @__PURE__ */ __name(async (code, id) => {
  ...
  if (isSvelteComponent(id)) {
    const processed = await preprocess2(
      code,
      {
        script: /* @__PURE__ */ __name(({ content, attributes }) => {
...
var mutateStaticState = /* @__PURE__ */ __name(async (id, module, className, propertyName, value) => {
...
var plugin = /* @__PURE__ */ __name((options) => {
  return {
    ...
    configureServer(server) {
      createRPCServer("threlte-studio", server.ws, {
        mutateStaticState(id, module, className, propertyName, value) {
          return mutateStaticState(id, module, className, propertyName, value);
        },
