...
export const syncTransactions = async (transactions) => {
    const transactionsByModuleId = new Map();
    ...
    for (const [moduleId, transactions] of transactionsByModuleId.entries()) {
        ...
        transactions.forEach((transaction) => {
            ...
            componentParser.upsertAttribute(magicMarkup, node, transaction.attributeName, transaction.attributeValue, 'last', transaction.precision);
