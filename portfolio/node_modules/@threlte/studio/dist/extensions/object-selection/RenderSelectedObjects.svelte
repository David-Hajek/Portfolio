...
<script lang="ts">import { isInstanceOf, T, useTask, useThrelte, watch } from '@threlte/core';
import { Portal } from '@threlte/extras';
import { onMount } from 'svelte';
import { Color, Mesh, MeshBasicMaterial, RGBAFormat, WebGLRenderTarget } from 'three';
...
const getOverrideMaterial = (id) => {
    ...
    if (overrideMaterialPool.has(mapIndex))
        return overrideMaterialPool.get(mapIndex);
