<script lang="ts">import { observe, T, useThrelte, watch } from '@threlte/core';
...
const editorCamera = $derived(mode === 'Orthographic' ? editorCameraOrthographic : editorCameraPerspective);
...
observe(() => [defaultCameraObject, editorCameraEnabled, editorCamera], ([defaultCameraObject, editorCameraEnabled, editorCamera]) => {
...
const onModeChange = (mode) => {
    if (mode === 'Perspective')
        extension.setPerspective();
    if (mode === 'Orthographic')
        extension.setOrthographic();
};
</script>
