...
export class StaticState {
    static [instances] = new SvelteMap();
    static [cache] = new SvelteMap();
    [staticStateMetaKey];
    ...
    static [setValue](constructor, property, value) {
    ...
    static [getCachedValue](constructor, property) {
        StaticState[cache].forEach((_, cons) => {
            console.log(cons.name, constructor.name, cons === constructor, cons.prototype === constructor.prototype);
        });
        const c = StaticState[cache].get(constructor);
        return c?.[property];
    }
